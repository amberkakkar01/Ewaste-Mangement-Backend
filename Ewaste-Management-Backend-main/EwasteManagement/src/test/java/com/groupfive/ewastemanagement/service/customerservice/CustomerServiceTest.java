...
class CustomerServiceTest {
    ...
    void getAllOrders_Success() {
        ...
        EnvelopeMessage envelopeMessage= (EnvelopeMessage) customerService.getAllOrders(request).getBody();
    ...
    void getAllOrders_Failure() {
        ...
        EnvelopeMessage envelopeMessage1= (EnvelopeMessage) customerService.getAllOrders(request).getBody();
    ...
    void viewProfile() {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage)customerService.viewProfile(request).getBody();
    ...
    void editProfile() {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage)customerService.editProfile(userModel,request).getBody();
    ...
    void viewDrives_Success() {
        ...
        EnvelopeMessage envelopeMessage= (EnvelopeMessage) customerService.viewDrives(request).getBody();
    ...
    void viewDrives_Failure() {
        ...
        EnvelopeMessage envelopeMessage1= (EnvelopeMessage) customerService.viewDrives(request).getBody();
    ...
    void viewCollectorProfile_Success() {
        ...
        EnvelopeMessage envelopeMessage= (EnvelopeMessage) customerService.viewCollectorProfile(collector.getUid()).getBody();
    ...
    void viewCollectorProfile_Failure() {
        ...
        EnvelopeMessage envelopeMessage1= (EnvelopeMessage) customerService.viewCollectorProfile(collector.getUid()).getBody();
    ...
    void viewNotification_Success() {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) customerService.viewNotification(request).getBody();
    ...
    void readNotification_Success() {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) customerService.readNotification(request).getBody();
    ...
    void getAnalytics()
    {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) customerService.getAnalytics(request).getBody();
    ...
    void getAnalyticsV2()
    {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) customerService.getAnalyticsV2(request).getBody();
        HashMap<String,Integer> hashMap1 = (HashMap) envelopeMessage.getData();
    ...
    void getAnalyticsV3(){
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) customerService.getAnalyticsV3(request).getBody();
