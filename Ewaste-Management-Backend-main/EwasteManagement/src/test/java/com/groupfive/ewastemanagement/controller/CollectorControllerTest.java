...
import static com.groupfive.ewastemanagement.helper.Constants.TEMP_COLLECTED;
...
class CollectorControllerTest {
    ...
    void getPendingRequest_Success(){
        ...
        EnvelopeMessage envelopeMessage =(EnvelopeMessage) collectorController.getPendingRequest(request).getBody();
    ...
    void getPendingRequest_Failure(){
        ...
        EnvelopeMessage envelopeMessage2 =(EnvelopeMessage) collectorController.getPendingRequest(request).getBody();
        assertEquals(NO_REQUEST_PENDING,envelopeMessage2.getData());
    }
    ...
    void getRequestSummary_Success(){
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) collectorController.getRequestSummary(request).getBody();
    ...
    void getRequestSummary_Failure(){
        ...
        EnvelopeMessage envelopeMessage1=(EnvelopeMessage) collectorController.getRequestSummary(request).getBody();

        assertEquals(NO_ORDERS,envelopeMessage1.getData());
    }
    ...
    void acceptPendingRequest_Success()
    {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.acceptPendingRequest(orders.getOrderUid(),request).getBody();
    ...
    void acceptPendingRequest_Failure()
    {
        ...
        EnvelopeMessage envelopeMessage1 = (EnvelopeMessage) collectorController.acceptPendingRequest(orders.getOrderUid(),request).getBody();
        assertEquals(NO_SUCH_ORDER_EXIST,envelopeMessage1.getData());
    ...
    void organizeDrive_Success()
    {
        ...
        EnvelopeMessage envelopeMessage =(EnvelopeMessage) collectorController.organizeDrive(eWasteDriveModel,request).getBody();
    ...
    void organizeDrive_Failure()
    {
        ...
        EnvelopeMessage envelopeMessage1 =(EnvelopeMessage) collectorController.organizeDrive(null,request).getBody();
        assertEquals(NO_DATA_PROVIDED,envelopeMessage1.getData());
    }
    ...
    void sellItem_Success()
    {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.sellItem(sellItemModel,request).getBody();
    ...
    void sellItem_Failure()
    {
        ...
        EnvelopeMessage envelopeMessage1 = (EnvelopeMessage) collectorController.sellItem(null,request).getBody();
        assertEquals(ENTER_ALL_DETAILS,envelopeMessage1.getData());
    }
    ...
    void viewMyDrive_Success(){
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.viewMyDrive(request).getBody();
    ...
    void viewMyDrive_Failure(){
        ...
        EnvelopeMessage envelopeMessage1 = (EnvelopeMessage) collectorController.viewMyDrive(request).getBody();
        assertEquals(ENTER_ALL_DETAILS,envelopeMessage1.getData());
    }
    ...
    void viewProfile_Success(){
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.viewProfile(request).getBody();
    ...
    void viewProfile_Failure(){
        ...
        EnvelopeMessage envelopeMessage1 = (EnvelopeMessage) collectorController.viewProfile(request).getBody();
        assertEquals(NO_SUCH_USER_FOUND, envelopeMessage1.getData());
    ...
    void editProfile_Success() {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) collectorController.editProfile(userModel,request).getBody();
        Collector c=(Collector) envelopeMessage.getData();
        assertEquals(collector.getEmail(), c.getEmail());
    }
    ...
    void editProfile_Failure() {
        ...
        when(collectorRepo.findByEmail(collector.getEmail())).thenReturn((null));
        EnvelopeMessage envelopeMessage1=(EnvelopeMessage) collectorController.editProfile(userModel,request).getBody();
        assertEquals(NO_SUCH_USER_FOUND, envelopeMessage1.getData());
    }
    ...
    void sellItemSoldSummary_Success() {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.sellItemSoldSummary(request).getBody();
    ...
    void sellItemAvailableSummary_Success() {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.sellItemAvailableSummary(request).getBody();
    ...
    void sellItemAvailableSummary_Failure() {
        ...
        EnvelopeMessage envelopeMessage1 = (EnvelopeMessage) collectorController.sellItemAvailableSummary(request).getBody();

        assertEquals(NO_ITEMS_IN_SALE,envelopeMessage1.getData());
    }
    ...
    void viewCustomerProfile_Success() {
        ...
        EnvelopeMessage envelopeMessage= (EnvelopeMessage) collectorController.viewCustomerProfile(customer.getUid()).getBody();
    ...
    void viewCustomerProfile_Failure() {
        ...
        EnvelopeMessage envelopeMessage1= (EnvelopeMessage) collectorController.viewCustomerProfile(customer.getUid()).getBody();
        assertEquals(PROFILE_NOT_FOUND,envelopeMessage1.getData());
    }
    ...
    void viewNotification_Success()
    {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) collectorController.viewNotification(request).getBody();
    ...
    void readNotification_Success()
    {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) collectorController.readNotification(request).getBody();
        List<Notification>customerNotification1= (List<Notification>) envelopeMessage.getData();
    ...
    void editDriveSummary_Success()
    {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) collectorController.editDriveSummary(eWasteDrive.getId(),"upcoming",request).getBody();
        EWasteDrive eWasteDrive1= (EWasteDrive) envelopeMessage.getData();
        assertEquals(eWasteDrive.getCollectorEmail(),eWasteDrive1.getCollectorEmail());
    }
    ...
    void editDriveSummary_Failure()
    {
        ...
        EnvelopeMessage envelopeMessage1=(EnvelopeMessage) collectorController.editDriveSummary(eWasteDrive.getId(),"upcoming",request).getBody();
        assertEquals(DRIVE_NOT_FOUND,envelopeMessage1.getData());
    }
    ...
    void getAnalytics()
    {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.getAnalyticsV1(request).getBody();
    ...
    void getAnalyticsV2()
    {
        ...
        when(ordersRepo.findByCategoryAndCollectorUid(LARGE_EQIP, collectorList.get(0).getUid())).thenReturn(listLargeEqipCollected);

        List<Orders> listSmallEquipCollected =new ArrayList<>();
        listSmallEquipCollected.add(orders);
        when(ordersRepo.findByCategoryAndCollectorUid(SMALL_EQUIP, collectorList.get(0).getUid())).thenReturn(listSmallEquipCollected);

        List<Orders> listSmallITCollected =new ArrayList<>();
        listSmallITCollected.add(orders);
        when(ordersRepo.findByCategoryAndCollectorUid(SMALL_IT, collectorList.get(0).getUid())).thenReturn(listSmallITCollected);
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage)collectorController.getAnalyticsV2(request).getBody();
    ...
    void getAnalyticsV4()
    {
        ...
        HashMap<String,Integer> hashMap = new HashMap<>();
        hashMap.put(VENDOR_CITY,listVendorInCity.size());
        hashMap.put(VENDOR_ALL_CITY,listOfVendorAll.size());

        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.getAnalyticsV4(request).getBody();
        HashMap<String,Integer> hashMap1 = (HashMap) envelopeMessage.getData();

        assertEquals(hashMap.get(VENDOR_CITY),hashMap1.get(VENDOR_CITY));
    ...
    void getAnalyticsV5()
    {
        ...
        HashMap<String,Integer> hashMap = new HashMap<>();
        hashMap.put(CUSTOMER_CITY,listCustomerInCity.size());
        hashMap.put(CUSTOMER_ALL_CITY,listCustomerAll.size());

        EnvelopeMessage envelopeMessage = (EnvelopeMessage) collectorController.getAnalyticsV5(request).getBody();
        HashMap<String,Integer> hashMap1 = (HashMap) envelopeMessage.getData();

        assertEquals(hashMap.get(CUSTOMER_CITY),hashMap1.get(CUSTOMER_CITY));
    }
}