...
class VendorControllerTest {
    ...
    void viewProfile_SUCCESS() {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) vendorController.viewProfile(request).getBody();
    ...
    void viewProfile_FAILURE() {
        ...
        EnvelopeMessage envelopeMessage1 = (EnvelopeMessage) vendorController.viewProfile(request).getBody();
    ...
    void viewAccept() {
        ...
        EnvelopeMessage envelopeMessage= (EnvelopeMessage) vendorController.viewAccept(acceptSellItemsVendor,request).getBody();
    ...
    void editProfile_SUCCESS() {
        ...
        when(vendorRepo.findByEmail(vendor.getEmail())).thenReturn((vendor));
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) vendorController.editProfile(userModel,request).getBody();
        Vendor c=(Vendor) envelopeMessage.getData();
        assertEquals(vendor.getEmail(), c.getEmail());

        when(vendorRepo.findByEmail(vendor.getEmail())).thenReturn((null));
        EnvelopeMessage envelopeMessage1=(EnvelopeMessage) vendorController.editProfile(userModel,request).getBody();
        assertEquals(NO_SUCH_USER_FOUND, envelopeMessage1.getData());
    }
    ...
    void viewAllItemOnSale_SUCCESS() {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) vendorController.viewAllItemOnSale().getBody();
    ...
    void viewAllItemOnSale_FAILURE() {
        ...
        EnvelopeMessage envelopeMessage2 = (EnvelopeMessage) vendorController.viewAllItemOnSale().getBody();
    ...
    void orderSummary_SUCCESS() {
        ...
        EnvelopeMessage envelopeMessage= (EnvelopeMessage) vendorController.orderSummary(request).getBody();
    ...
    void orderSummary_FAILURE() {
        ...
        EnvelopeMessage envelopeMessage2= (EnvelopeMessage) vendorController.orderSummary(request).getBody();
        assertEquals(NO_SUCH_ORDER_EXIST,envelopeMessage2.getData());
    }
    ...
    void viewCollectorProfileSummary_SUCCESS() {
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) vendorController.viewCollectorProfileInSummary(vendorOrders.getId(), request).getBody();
    ...
    void viewCollectorProfileSummary_FAILURE() {
        ...
        EnvelopeMessage envelopeMessage2=(EnvelopeMessage) vendorController.viewCollectorProfileInSummary(vendorOrders.getId(), request).getBody();
    ...
    void viewCollectorProfile_SUCCESS()
    {
        ...
        when(collectorRepo.findByUid(sellItems.getCollectorUid())).thenReturn(collector);
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) vendorController.viewCollectorProfile(sellItems.getId(), request).getBody();
        Collector collector1=(Collector) envelopeMessage.getData();
    ...
    void viewCollectorProfile_FAILURE()
    {
        ...
        EnvelopeMessage envelopeMessage2=(EnvelopeMessage) vendorController.viewCollectorProfile(sellItems.getId(), request).getBody();
        assertEquals("No Collector Found",envelopeMessage2.getData());
    }
    ...
    void getAnalyticsV1()
    {
        ...
        EnvelopeMessage envelopeMessage = (EnvelopeMessage) vendorController.getAnalyticsV1(request).getBody();
    ...
    void getAnalyticsV2()
    {
        ...
        EnvelopeMessage envelopeMessage= vendorController.getAnalyticsV2(request).getBody();
    ...
    void getAnalyticsV4(){
        ...
        EnvelopeMessage envelopeMessage=(EnvelopeMessage) vendorController.getAnalyticsV4(request).getBody();
        HashMap<String,Integer>hashMap= (HashMap<String, Integer>) envelopeMessage.getData();
